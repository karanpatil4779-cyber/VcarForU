...
const AgencyDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (bookings.length === 0) {
      setBookings([
        { id: 'b1', userId: 'u1', userName: 'Aarav Singh', userEmail: 'aarav@example.com', vehicle: 'Hyundai Creta', city: 'Mumbai', startDate: '2026-04-20', endDate: '2026-04-22', amount: 3600, status: 'Confirmed', paymentMethod: 'UPI', createdAt: '2026-04-18T10:30:00Z' },
        { id: 'b2', userId: 'u2', userName: 'Jiya Patel', userEmail: 'jiya@example.com', vehicle: 'Toyota Innova', city: 'Mumbai', startDate: '2026-04-23', endDate: '2026-04-25', amount: 4500, status: 'Confirmed', paymentMethod: 'Card', createdAt: '2026-04-19T14:20:00Z' },
        { id: 'b3', userId: 'u3', userName: 'Rohan Mehta', userEmail: 'rohan@example.com', vehicle: 'Honda City', city: 'Pune', startDate: '2026-04-26', endDate: '2026-04-28', amount: 3000, status: 'Pending', paymentMethod: 'UPI', createdAt: '2026-04-20T09:15:00Z' },
        { id: 'b4', userId: 'u4', userName: 'Priya Sharma', userEmail: 'priya@example.com', vehicle: 'Maruti Swift', city: 'Mumbai', startDate: '2026-04-15', endDate: '2026-04-16', amount: 1200, status: 'Completed', paymentMethod: 'UPI', createdAt: '2026-04-10T11:00:00Z' },
        { id: 'b5', userId: 'u5', userName: 'Vikram Singh', userEmail: 'vikram@example.com', vehicle: 'Kia Seltos', city: 'Nashik', startDate: '2026-04-29', endDate: '2026-05-01', amount: 4200, status: 'Confirmed', paymentMethod: 'Card', createdAt: '2026-04-21T16:45:00Z' },
        { id: 'b6', userId: 'u6', userName: 'Ananya Reddy', userEmail: 'ananya@example.com', vehicle: 'Tata Nexon', city: 'Mumbai', startDate: '2026-05-02', endDate: '2026-05-04', amount: 2700, status: 'Pending', paymentMethod: 'UPI', createdAt: '2026-04-22T08:30:00Z' },
        { id: 'b7', userId: 'u7', userName: 'Karan Joshi', userEmail: 'karan@example.com', vehicle: 'Hyundai Venue', city: 'Pune', startDate: '2026-04-18', endDate: '2026-04-19', amount: 1100, status: 'Completed', paymentMethod: 'Card', createdAt: '2026-04-15T13:00:00Z' },
        { id: 'b8', userId: 'u8', userName: 'Neha Gupta', userEmail: 'neha@example.com', vehicle: 'Mahindra XUV500', city: 'Mumbai', startDate: '2026-05-05', endDate: '2026-05-07', amount: 5400, status: 'Confirmed', paymentMethod: 'UPI', createdAt: '2026-04-23T10:20:00Z' },
      ]);
    }

    if (vehicles.length === 0) {
      setVehicles([
        { id: 'v1', name: 'Hyundai Creta', brand: 'Hyundai', category: 'suv', type: 'SUV', fuel: 'Petrol', transmission: 'Automatic', seats: 5, mileage: '18 kmpl', pricePerKm: 18, deposit: 5000, location: 'Andheri', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1525609004556-c46c7d6cf023?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.7, reviews: 23 },
        { id: 'v2', name: 'Toyota Innova', brand: 'Toyota', category: 'suv', type: 'MPV', fuel: 'Diesel', transmission: 'Automatic', seats: 7, mileage: '15 kmpl', pricePerKm: 22, deposit: 8000, location: 'Powai', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1605218457331-9c4c79757c13?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.9, reviews: 45 },
        { id: 'v3', name: 'Honda City', brand: 'Honda', category: 'sedan', type: 'Sedan', fuel: 'Petrol', transmission: 'Manual', seats: 5, mileage: '20 kmpl', pricePerKm: 15, deposit: 4000, location: 'Bandra', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1617788138017-80ad40651399?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.5, reviews: 18 },
        { id: 'v4', name: 'Maruti Swift', brand: 'Maruti', category: 'hatchback', type: 'Hatchback', fuel: 'Petrol', transmission: 'Manual', seats: 4, mileage: '22 kmpl', pricePerKm: 12, deposit: 3000, location: 'Lower Parel', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1606629641977-598baa69fe52?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.3, reviews: 67 },
        ...
        { id: 'v6', name: 'Tata Nexon', brand: 'Tata', category: 'suv', type: 'SUV', fuel: 'Petrol', transmission: 'Manual', seats: 5, mileage: '19 kmpl', pricePerKm: 14, deposit: 3500, location: 'Kurla', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1553535660-65563d25c1e3?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.4, reviews: 29 },
        { id: 'v7', name: 'Mahindra XUV500', brand: 'Mahindra', category: 'suv', type: 'SUV', fuel: 'Diesel', transmission: 'Automatic', seats: 7, mileage: '14 kmpl', pricePerKm: 25, deposit: 9000, location: 'Juhu', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.8, reviews: 12 },
        { id: 'v8', name: 'Hyundai Venue', brand: 'Hyundai', category: 'suv', type: 'SUV', fuel: 'Petrol', transmission: 'Manual', seats: 5, mileage: '18 kmpl', pricePerKm: 16, deposit: 4500, location: 'Worli', city: 'Mumbai', image: 'https://images.unsplash.com/photo-1533473359331-0135ef1bcfb0?auto=format&fit=crop&w=1200&q=80', agency: user.name, agencyId: user.id, rating: 4.2, reviews: 15 },
      ]);
    }
  }, [user]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSaving(true);
    const newVehicle = {
      id: `v-${Date.now()}`, name: form.name.trim(), brand: form.brand.trim(), category: form.category || 'sedan',
